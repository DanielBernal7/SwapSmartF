		...
		<View style={styles.container}>
			...
			<Modal visible={modalVisible} animationType="slide">
				<View style={{ flex: 1, paddingHorizontal: 20, paddingTop: 100 }}>
					{selectedFood && (
						<>
							<Text style={{ fontSize: 22, fontWeight: "bold", marginBottom: 5 }}>{details?.name}</Text>

							{details?.brand && <Text style={{ fontSize: 14, color: "#666", marginBottom: 5 }}>{details.brand}</Text>}

							<Text style={{ fontSize: 12, color: "#999", marginBottom: 20 }}>ID: {details?.id}</Text>
